...
Бывшие в Google AdWords типы отчётов, в Google Ads стали ресурсами. Ниже — таблица сопоставления из [официальной справки](https://developers.google.com/google-ads/api/docs/migration/mapping):
...
Соответствие полей «Отчёт» и полей ресурсов можно найти в [официальной справке](https://developers.google.com/google-ads/api/docs/migration/mapping#field_mappings_for_reports). Таблица очень большая, поэтому не вижу смысла дублировать её здесь.
